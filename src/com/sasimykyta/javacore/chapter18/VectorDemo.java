...
class VectorDemo {
    public static void main(String args[]) {
        ...
        System.out.println("Начальная емкость вектора: " +
                v.capacity());
        ...
        System.out.println("Емкость вектора после добавления 4 элементов: " +
                v.capacity());
        v.addElement(5);
        System.out.println("Текущая емкость вектора: " +
                v.capacity());
        v.addElement(6);
        v.addElement(7);
        ...
        System.out.println("Последниий элемент вектора: " + v.lastElement());
